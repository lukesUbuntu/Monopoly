...
namespace MonopolyGame_9901623
{
    ...
    class _TestProperty
    {
        ...
        [Test]
        public void test_unMortgagePropertyPrice()
        {
            //set trader
            Trader theTrader = new Trader();
            theTrader.setName("Trader");
            ...
            //setup prop
            Property theProp = new Property("Garden", ref theTrader, 100);
            decimal expected_morgage = (100 * 10 / 100) + 100;


            Assert.AreEqual(expected_morgage, theProp.unMortgagePropertyPrice());
            //Assert.AreSame(expected_morgage, theProp.unMortgagePropertyPrice());
        }
        [Test]
        public void test_mortgagePropertyPrice()
        {
            //set trader
            Trader theTrader = new Trader();
            theTrader.setName("Trader");
            ...
            //setup prop
            Property theProp = new Property("Garden", ref theTrader, 100);
            decimal expected_morgage = 100;


            Assert.AreEqual(expected_morgage, theProp.mortgagePropertyPrice());
            //Assert.AreSame(expected_morgage, theProp.unMortgagePropertyPrice());
        }
